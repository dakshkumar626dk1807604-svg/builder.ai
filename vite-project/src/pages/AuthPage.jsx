            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  required
                  className='w-full pl-2 py-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950 text-sm text-zinc-900 bg-transparent placeholder:text-zinc-300 transition-colors'
            ...
            <div>
              ...
              <div className='relative'>
                <input
                  ...
                  required
                  className='w-full pl-2 py-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950 text-sm text-zinc-900 bg-transparent placeholder:text-zinc-300 pr-8'
                  placeholder='••••••••'
                />
                <button
                  type='button'
